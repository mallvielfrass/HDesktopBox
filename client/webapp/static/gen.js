...
info='<div><b>Название: </b>'+object.title+'</div>'+'<div><b>Оригинальное название: </b>'+object.original_title+'</div><div><b>Год: </b>'+object.year+'</div><div><b>Страна: </b>'+country+'</div>'+'<div><b>Создатели: </b>'+creators+'</div>'+'<div><b>Описание: </b>'+stor+'</div>'
